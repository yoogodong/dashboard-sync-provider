...
select i.issue_key, count(h.id) as times,i.project_key,i.component_name, i.fix_version_name
from issue i
...
group by i.issue_key,i.project_key,i.component_name, i.fix_version_name
union
select i.issue_key, count(h.id) as times,i.project_key,i.component_name, i.fix_version_name
from issue i
         join history h on i.id = h.issue_id
